...
namespace vislab
{
    ...
    class RegularGrid : public Concrete<RegularGrid<TScalar, TDimensions>, BaseGrid<TDimensions>>
    {
    public:
        /**
         ...
         */
        [[nodiscard]] inline Eigen::Index getNumGridPoints() const override
        {
         ...
         */
        [[nodiscard]] Eigen::Index getNumCells() const override
        {
         ...
         */
        [[nodiscard]] Eigen::VectorX<Eigen::Index> getCell(Eigen::Index cellIndex) const override
        {
